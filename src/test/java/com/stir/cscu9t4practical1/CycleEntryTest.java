...
public class CycleEntryTest {
    ...
    public void testGetName() {
        ...
        Entry instance = new CycleEntry("Alice", "run",1, 2, 2003, 0, 16, 7, 3F, "asphalt", "moderate");
    ...
    public void testGetDay() {
        ...
        Entry instance = new CycleEntry("Alice", "run",1, 2, 2003, 0, 16, 7, 3F, "gravel", "moderate");
        int expResult = 1;
    ...
    public void testGetMonth() {
        ...
        Entry instance = new CycleEntry("Alice", "run",1, 2, 2003, 0, 16, 7, 3F, "mountain", "fast");
        int expResult = 2;
    ...
    public void testGetYear() {
        ...
        Entry instance = new CycleEntry("Alice", "run",1, 2, 2003, 0, 16, 7, 3F, "gravel", "slow");
        int expResult = 2003;
    ...
    public void testGetHour() {
        ...
        Entry instance = new CycleEntry("Alice", "run",1, 2, 2003, 0, 16, 7, 3F, "asphalt", "fast");
        int expResult = 0;
